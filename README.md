# Generative AI Course: Python Assignments

This repository tracks my hands-on coding assignments for the **Generative AI Course** by **Tutedude**. It serves as a centralized hub for all my core Python scripts, logical workflows, and foundational data processing exercises.

---

## 📋 Assignment Index

* **`Assignment1.ipynb` (Data Structures & Cataloging)**
  * Working with mutable lists and immutable tuples.
  * Utilizing sets to manage unique product categories without duplication.
